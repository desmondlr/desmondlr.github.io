...
categories:
- General
feature_image: "/assets/thesis_summary/force_probe.png"
---

[Previously, I shared a brief post]({{ site.baseurl }}{% link _posts/2025-05-29-msc-thesis.md %}) featuring the abstract and linking to the full text of my MSc. thesis. While that version presents the formal academic work, I wanted to follow it up with something more accessible — a professional summary that highlights what I actually did, what I learned, and how the project reflects my strengths as a developer and collaborator.
...
![Pictograph indicating process through characterizing sliders, interpreting force profiles, simulating sliders, and then analysing data from the user study.](/assets/thesis_summary/overview.jpg)
...
![A control panel with many buttons, knobs, sliders, and switches.](/assets/thesis_summary/rothney_control_panel.jpg)
...
![A photo of the vibrotactile actuator.](/assets/thesis_summary/tactile_actuator.png) 
...
<h3>Skills and Contributions</h3>
<h5>Ideation, Planning, and Early Development</h5>

<ul>
    <li>Scoped a complex interaction challenge by identifying sliders as a practical and high-impact use case for simplified haptics in VR.</li>
    <li>Conducted a structured investigation of related technologies and prior approaches to inform design decisions. Similar to a competitive landscape review or technical discovery phase.</li>
    <li>Translated domain research into actionable system requirements and development priorities.</li>
    <li>Adapted and extended existing algorithms to suit new constraints.</li>
    <li>Defined success metrics and user-facing goals early, enabling focused development and measurable outcomes; aligned with product thinking in technical roles.</li>
    <li>Collaborated with a small team to develop underlying simulation platform. We implemented industry-standard software development practices throughout the project, including:
    <ul>
    <li>Scrum-based development with iterative planning</li>
    <li>Azure DevOps CI/CD pipelines and CMake for build and deployment automation</li>
    <li>Enforced Git-based code review policies via protected branches</li>
    <li>Internal documentation and custom artifact generation tools to improve process clarity</li>
    </ul>
    </li>
</ul>

<h5>Hardware Prototyping</h5>
...
![A photo of the custom probe for measuring the force-displacement profiles of sliders. It has several 3d printed jigs holding off-the-shelf components that are grouped in colored boxes.The red box indicates the actuaton group containing components 1 and 3, the computer and linear actuator. The green box indicates the sensing group containing components 1, 2, and 5, the computer, oscilloscope, and force sensor. The orange box indicates the physical probe assembly, containging components 3, 4, and 5, the linear actuator, target slider, and force sensor.](/assets/thesis_summary/annotated_force_probe.png)

<h5>Spatial Computing</h5>
...
<h5>Research, Data, and Evaluation</h5>
